import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,b as a}from"./app-xMrARyrX.js";const s={},d=a(`<h2 id="frame" tabindex="-1"><a class="header-anchor" href="#frame" aria-hidden="true">#</a> Frame</h2><h2 id="window-方法" tabindex="-1"><a class="header-anchor" href="#window-方法" aria-hidden="true">#</a> window 方法</h2><h3 id="window-open弹窗" tabindex="-1"><a class="header-anchor" href="#window-open弹窗" aria-hidden="true">#</a> window.open弹窗</h3><p>打开一个弹窗的语法是 window.open(url, name, params)：</p><ul><li>url // 新窗口的 url</li><li>name // 窗口名字</li><li>params // 新窗口的配置</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>位置:
