import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as l,c as i,a as c,b as o,w as p,f as u,d as n,e as s}from"./app-c8wFea3_.js";const d={},r=u(`<h2 id="pc端-大屏-led屏幕" tabindex="-1"><a class="header-anchor" href="#pc端-大屏-led屏幕" aria-hidden="true">#</a> PC端|大屏|LED屏幕</h2><h3 id="led屏幕" tabindex="-1"><a class="header-anchor" href="#led屏幕" aria-hidden="true">#</a> LED屏幕</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 屏幕在缩小的情况下，使用如下 css 样式，让屏幕撑满全屏
body{
 transform: scale(0.5);
