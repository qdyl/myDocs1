import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as l,c as r,e,f as i,d,w as o,a as c,b as n}from"./app-LQCnbNa2.js";const v={},m=e("h2",{id:"跨域经验",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#跨域经验","aria-hidden":"true"},"#"),i(" 跨域经验")],-1),u=n(`<h2 id="保留页面滚动条位置" tabindex="-1"><a class="header-anchor" href="#保留页面滚动条位置" aria-hidden="true">#</a> 保留页面滚动条位置</h2><h3 id="方式1-路由配置" tabindex="-1"><a class="header-anchor" href="#方式1-路由配置" aria-hidden="true">#</a> 方式1：路由配置</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 文件： src/router/index.js 
const createRouter = () =&gt;
  new Router({
