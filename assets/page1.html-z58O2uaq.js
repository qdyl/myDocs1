import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,a as s,d as e}from"./app-9O0glKUP.js";const t={},l=e(`<h2 id="保留页面滚动条位置" tabindex="-1"><a class="header-anchor" href="#保留页面滚动条位置" aria-hidden="true">#</a> 保留页面滚动条位置</h2><h3 id="方式1-路由配置" tabindex="-1"><a class="header-anchor" href="#方式1-路由配置" aria-hidden="true">#</a> 方式1：路由配置</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 文件： src/router/index.js 
const createRouter = () =&gt;
  new Router({
