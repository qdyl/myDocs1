import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as c,c as r,d as u,w as s,a as n,e as p,f as t,b as d}from"./app-1NjjKqHv.js";const k={},v=p("h2",{id:"webpack-优化介绍",tabindex:"-1"},[p("a",{class:"header-anchor",href:"#webpack-优化介绍","aria-hidden":"true"},"#"),t(" webpack 优化介绍")],-1),m=p("p",null,"configureWebpack 配置的两种方式",-1),b=d(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>对象方式：
module.exports = {
  configureWebpack: {
    // 在这里可以直接配置 webpack
  }
